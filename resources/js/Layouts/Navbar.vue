...
const showMyProfile = () => Inertia.get(route("myProfile"));
</script>
...
<template>
    <div class="navbar-custom topnav-navbar topnav-navbar-dark">
        <div class="container-fluid">
            <!-- LOGO -->
            <a href="#" class="topnav-logo mt-[10px]">
                <Logo :show="false">
                    <Link
                        :href="route('dashboard')"
                        :v-show="topnav - logo - lg ? true : false"
                    >
                        <span
                            ><img
            ...
            <ul class="list-unstyled topbar-menu float-end mb-0">
                ...
                <li class="notification-list !mt-0">
                    <a
                ...
                <li class="dropdown notification-list !mt-0">
                    ...
                    >
                        ...
                        <span>
                            ...
                            <span class="account-position uppercase">{{
                                user?.role
                            }}</span>
                        </span>
                    </a>
